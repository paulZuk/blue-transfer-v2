...
$(function () {
    ...
    var getGalleryPhotos = function getGalleryPhotos() {
        return $('.gallery-photo');
    };
    var randomRotateValue = function randomRotateValue(from, to) {
        var random = Math.floor(Math.random() * to) + from;
        random *= Math.floor(Math.random() * 2) == 1 ? 1 : -1;
        return random;
    };
    var createPhotoArray = function createPhotoArray(photos) {
        var photoArray = [];
        for (var i = 0; i < photos.length; i++) {
            photoArray.push(i + 1);
        }
        return photoArray.sort(function (a, b) {
            return 0.5 - Math.random();
        });
    };
    var setGalleryPhotos = function setGalleryPhotos() {
        var frame = getGalleryPhotos().toArray();
        var photoArray = createPhotoArray(frame);
    ...
    var onEnterPhoto = function onEnterPhoto(evt) {
        $(evt.target).addClass('hover');
    };
    var onLeavePhoto = function onLeavePhoto(evt) {
        $(evt.target).removeClass('hover');
    };
    var setClickEvent = function setClickEvent() {
        var photos = getGalleryPhotos();
        photos.on('click', onClickPhoto);
    };
    var setOnEnterEvent = function setOnEnterEvent() {
        var photos = getGalleryPhotos();
        photos.on('mouseenter', onEnterPhoto);
    };
    var offOnEnterEvent = function offOnEnterEvent() {
        var photos = getGalleryPhotos();
        photos.off('mouseenter', onEnterPhoto);
    };
    var setOnLeaveEvent = function setOnLeaveEvent() {
        var photos = getGalleryPhotos();
    ...
    var onClickPhoto = function onClickPhoto(evt) {
        var isActive = $(evt.target).hasClass('active');
        resetPhotos();
        if (!isActive) {
            $(evt.target).addClass('active').removeClass('hover');
